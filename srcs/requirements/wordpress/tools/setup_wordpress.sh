...
if [ -z "${WORDPRESS_DB_NAME}" ]; then
    echo "ERROR: WORDPRESS_DB_NAME is empty"; exit 1
fi
if [ -z "${WORDPRESS_DB_USER}" ]; then
    echo "ERROR: WORDPRESS_DB_USER is empty"; exit 1
fi
if [ -z "${WORDPRESS_DB_PASSWORD}" ]; then
    echo "ERROR: WORDPRESS_DB_PASSWORD is empty"; exit 1
fi
if [ -z "${WORDPRESS_DB_HOST}" ]; then
    echo "ERROR: WORDPRESS_DB_HOST is empty"; exit 1
fi
